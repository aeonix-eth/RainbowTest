...
// node_modules/@wagmi/core/dist/base-68ec937e.esm.js
...
// node_modules/@wagmi/core/dist/chains-c389721d.esm.js
...
// node_modules/@wagmi/core/dist/client-5df5c2eb.esm.js
...
function watchBlockNumber(args, callback) {
  ...
  const client2 = getClient();
  const provider_ = (_client$webSocketProv = client2.webSocketProvider) !== null && _client$webSocketProv !== void 0 ? _client$webSocketProv : client2.provider;
  if (args.listen)
...
function useBlockNumber() {
  ...
  }, [chainId2, provider, queryClient, watch, webSocketProvider]);
...
function useContractRead(_ref3) {
  let {
    addressOrName,
    contractInterface,
    functionName,
  ...
  React11.useEffect(() => {
    if (enabled) {
      ...
      }, (result) => client2.setQueryData(queryKey_, result));
      return unwatch;
    }
  }, [addressOrName, args, cacheOnBlock, chainId2, client2, contractInterface, enabled, functionName, overrides, queryKey_, watch]);
...
function useContractReads(_ref3) {
  let {
    cacheOnBlock = false,
    cacheTime,
    contracts,
  ...
  }, [cacheOnBlock, client2, contracts, enabled, overrides, queryKey_, watch]);
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-UADQLXYM.js.map
