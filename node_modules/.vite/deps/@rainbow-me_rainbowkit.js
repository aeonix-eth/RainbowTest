...
import {
  ...
  useProvider,
  useSwitchNetwork
} from "./chunk-UADQLXYM.js";
import {
  require_eventemitter3
} from "./chunk-5YJSUS5B.js";
import {
  require_react_dom
...
var Box = React9.forwardRef(({ as = "div", className, ...props }, ref) => {
  const atomProps = {};
  const nativeProps = {};
  ...
  return React9.createElement(as, {
...
function AsyncImage({
  ...
  const [isRemoteImageLoaded, setRemoteImageLoaded] = (0, import_react5.useReducer)(() => true, false);
  return import_react5.default.createElement(Box, {
  ...
  }, import_react5.default.createElement(Box, {
    ...isRemoteImage ? {
      "aria-hidden": true,
      "as": "img",
    ...
    width: "full"
  }), borderColor ? import_react5.default.createElement(Box, {
...
var useRandomId = (prefix) => (0, import_react8.useMemo)(() => `${prefix}_${Math.round(Math.random() * 1e9)}`, [prefix]);
var SpinnerIcon = ({
  height = 21,
  width = 21
}) => {
  ...
  }, import_react8.default.createElement("clipPath", {
    id
  ...
  })), import_react8.default.createElement("foreignObject", {
    clipPath: `url(#${id})`,
    height: "21",
    width: "21",
    x: "0",
...
var EmojiAvatar = ({ address, ensImage, size }) => {
  const { color: backgroundColor, emoji } = (0, import_react10.useMemo)(() => emojiAvatarForAddress(address), [address]);
  return ensImage ? import_react10.default.createElement(Box, {
    backgroundSize: "cover",
    borderRadius: "full",
    position: "absolute",
    style: {
  ...
  }) : import_react10.default.createElement(Box, {
    alignItems: "center",
    display: "flex",
...
var AvatarContext = (0, import_react9.createContext)(defaultAvatar);
function Avatar({ address, imageUrl, loading, size }) {
  const AvatarComponent2 = (0, import_react7.useContext)(AvatarContext);
  return import_react7.default.createElement(Box, {
    "aria-hidden": true,
    borderRadius: "full",
    overflow: "hidden",
    position: "relative",
    ...
    userSelect: "none"
  }, import_react7.default.createElement(AvatarComponent2, {
    address,
    ensImage: imageUrl,
    size
  })), typeof loading === "boolean" && import_react7.default.createElement(Box, {
    color: "accentColor",
    display: "flex",
    height: "full",
    position: "absolute",
    ...
    width: "full"
  }, import_react7.default.createElement(SpinnerIcon, {
    height: "100%",
    width: "100%"
  })));
}
var DropdownIcon = () => import_react11.default.createElement("svg", {
  fill: "none",
  height: "7",
  width: "14",
  xmlns: "http://www.w3.org/2000/svg"
...
var useRainbowKitChains = () => (0, import_react12.useContext)(RainbowKitChainContext);
...
var useIsMounted = () => {
  const [mounted, setMounted] = (0, import_react14.useReducer)(() => true, false);
  (0, import_react14.useEffect)(setMounted, [setMounted]);
  return mounted;
};
function useChainId() {
  var _a;
...
var storeSingleton;
var TransactionStoreContext = (0, import_react16.createContext)(null);
function TransactionStoreProvider({
  ...
  const [store] = (0, import_react16.useState)(() => storeSingleton != null ? storeSingleton : storeSingleton = createTransactionStore({ provider }));
  ...
  return import_react16.default.createElement(TransactionStoreContext.Provider, {
    value: store
  }, children);
}
function useTransactionStore() {
  const store = (0, import_react16.useContext)(TransactionStoreContext);
  if (!store) {
...
function useRecentTransactions() {
  ...
  const { address } = useAccount();
  const chainId = useChainId();
  const [transactions, setTransactions] = (0, import_react15.useState)(() => store && address && chainId ? store.getTransactions(address, chainId) : []);
...
var AppContext = (0, import_react20.createContext)(defaultAppInfo);
var CoolModeContext = (0, import_react21.createContext)(false);
var ShowRecentTransactionsContext = (0, import_react22.createContext)(false);
var arbitrumIcon = {
  iconBackground: "#96bedc",
  iconUrl: async () => (await import("./arbitrum-RJBKFWDE-VWCBRKVA.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-GTODSNSK-AFAPUZ5I.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-TCZSTHSI-RTYKEKDV.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-VJNBZ2P3-VZVEFR6Q.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-3QUIF6AD-BRZ35BLL.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-JVGMAJ3S-YVFTSB6V.js")).default
};
...
var ThemeIdContext = (0, import_react19.createContext)(void 0);
var attr = "data-rk";
...
var useThemeRootProps = () => {
  const id = (0, import_react19.useContext)(ThemeIdContext);
...
function RainbowKitProvider({
  ...
  const rainbowkitChains = (0, import_react19.useMemo)(() => provideRainbowKitChains(chains), [chains]);
  ...
  return import_react19.default.createElement(RainbowKitChainContext.Provider, {
    value: rainbowkitChains
  }, import_react19.default.createElement(CoolModeContext.Provider, {
    value: coolMode
  }, import_react19.default.createElement(ShowRecentTransactionsContext.Provider, {
    value: showRecentTransactions
  }, import_react19.default.createElement(TransactionStoreProvider, null, import_react19.default.createElement(AvatarContext.Provider, {
    value: avatarContext
  }, import_react19.default.createElement(AppContext.Provider, {
    value: appContext
  }, import_react19.default.createElement(ThemeIdContext.Provider, {
    value: id
  }, theme ? import_react19.default.createElement("div", {
    ...createThemeRootProps(id)
  }, import_react19.default.createElement("style", {
...
function FocusTrap(props) {
  ...
  return import_react23.default.createElement(import_react23.default.Fragment, null, import_react23.default.createElement("div", {
    onFocus: (0, import_react23.useCallback)(() => contentRef.current && moveFocusWithin(contentRef.current, "end"), []),
    tabIndex: 0
    ...
    onFocus: (0, import_react23.useCallback)(() => contentRef.current && moveFocusWithin(contentRef.current, "start"), []),
    tabIndex: 0
  }));
}
...
function Dialog({ children, onClose, open, titleId }) {
  ...
  const handleBackdropClick = (0, import_react18.useCallback)(() => onClose(), [onClose]);
  const themeRootProps = useThemeRootProps();
  const mobile = isMobile();
  return import_react18.default.createElement(import_react18.default.Fragment, null, open ? (0, import_react_dom.createPortal)(import_react18.default.createElement(Combination_default, null, import_react18.default.createElement(Box, {
    ...themeRootProps
    ...
    position: "fixed",
    role: "dialog"
  }, import_react18.default.createElement(FocusTrap, {
    className: content,
...
function DialogContent({
  ...
  const mobile = isMobile();
  return import_react24.default.createElement(Box, {
    marginTop
  }, import_react24.default.createElement(Box, {
    className: [
...
var CloseIcon = () => {
  return isMobile() ? import_react27.default.createElement("svg", {
    "aria-hidden": true,
    fill: "none",
    height: "11.5",
...
var CloseButton = ({
  ...
  return import_react26.default.createElement(Box, {
    ...
    type: "button",
    width: mobile ? "30" : "28"
  }, import_react26.default.createElement(CloseIcon, null));
};
...
var CopiedIcon = () => import_react28.default.createElement("svg", {
  fill: "none",
  height: "13",
  viewBox: "0 0 13 13",
  width: "13",
...
var CopyIcon = () => import_react29.default.createElement("svg", {
  fill: "none",
  height: "16",
  viewBox: "0 0 17 16",
  width: "17",
...
var DisconnectIcon = () => import_react30.default.createElement("svg", {
  fill: "none",
  height: "16",
  viewBox: "0 0 18 16",
  width: "18",
...
var Text = import_react31.default.forwardRef(({
  as = "div",
  children,
  className,
  color,
...
var ExternalLinkIcon = () => import_react34.default.createElement("svg", {
  fill: "none",
  height: "19",
  viewBox: "0 0 20 19",
  width: "20",
...
var CancelIcon = () => import_react36.default.createElement("svg", {
  fill: "none",
  height: "19",
  viewBox: "0 0 20 19",
  width: "20",
...
var SuccessIcon = () => import_react37.default.createElement("svg", {
  fill: "none",
  height: "20",
  viewBox: "0 0 20 20",
  width: "20",
...
function TxItem({ tx }) {
  ...
  return import_react35.default.createElement(import_react35.default.Fragment, null, import_react35.default.createElement(Box, {
    ...explorerLink ? {
      as: "a",
    ...
    color
  }, import_react35.default.createElement(Icon, null)), import_react35.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: mobile ? "3" : "1"
  }, import_react35.default.createElement(Box, null, import_react35.default.createElement(Text, {
    color: "modalText",
    font: "body",
    size: mobile ? "16" : "14",
    weight: "bold"
  }, tx == null ? void 0 : tx.description)), import_react35.default.createElement(Box, null, import_react35.default.createElement(Text, {
    color: tx.status === "pending" ? "modalTextSecondary" : color,
    font: "body",
    size: "14",
    weight: mobile ? "medium" : "regular"
  }, confirmationStatus)))), explorerLink && import_react35.default.createElement(Box, {
    alignItems: "center",
    color: "modalTextDim",
    display: "flex"
  }, import_react35.default.createElement(ExternalLinkIcon, null))));
}
...
function TxList({ address }) {
  ...
  const mobile = isMobile();
  const { appName } = (0, import_react32.useContext)(AppContext);
  return import_react32.default.createElement(import_react32.default.Fragment, null, import_react32.default.createElement(Box, {
  ...
  }, hasTransactions && import_react32.default.createElement(Box, {
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, "Recent Transactions"), import_react32.default.createElement(Box, {
    style: {
      marginBottom: -6,
      marginLeft: -10,
      marginRight: -10,
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, "Clear All"))))), import_react32.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, hasTransactions ? visibleTxs.map((tx) => import_react32.default.createElement(TxItem, {
    key: tx.hash,
    tx
  })) : import_react32.default.createElement(import_react32.default.Fragment, null, import_react32.default.createElement(Box, {
    padding: mobile ? "12" : "8"
  }, import_react32.default.createElement(Text, {
    color: "modalTextDim",
    size: mobile ? "16" : "14",
    weight: mobile ? "medium" : "bold"
  }, appName != null ? appName : "Your", " transactions will appear here...")), mobile && import_react32.default.createElement(Box, {
    background: "generalBorderDim",
    height: "1",
    marginX: "12",
    marginY: "8"
  })))), explorerLink && import_react32.default.createElement(Box, {
    paddingBottom: "18",
    paddingX: mobile ? "8" : "18"
  }, import_react32.default.createElement(Box, {
    alignItems: "center",
  ...
  }, "View more on Explorer"), import_react32.default.createElement(ExternalLinkIcon, null))));
}
function ProfileDetailsAction({
  ...
  return import_react38.default.createElement(Box, {
    ...
    color: "modalText",
    height: "max"
  }, icon), import_react38.default.createElement(Box, null, import_react38.default.createElement(Text, {
    color: "modalText",
    size: mobile ? "12" : "13",
    weight: "semibold"
  }, label))));
...
function ProfileDetails({
  ...
  const showRecentTransactions = (0, import_react25.useContext)(ShowRecentTransactionsContext);
  const [copiedAddress, setCopiedAddress] = (0, import_react25.useState)(false);
  const copyAddressAction = (0, import_react25.useCallback)(() => {
    if (address) {
  ...
  const mobile = isMobile();
  return import_react25.default.createElement(import_react25.default.Fragment, null, import_react25.default.createElement(Box, {
    display: "flex",
    flexDirection: "column"
  }, import_react25.default.createElement(Box, {
  ...
  }, import_react25.default.createElement(CloseButton, {
    onClose
  })), " ", import_react25.default.createElement(Box, {
    marginTop: mobile ? "24" : "0"
  }, import_react25.default.createElement(Avatar, {
    address,
    imageUrl: ensAvatar,
    size: mobile ? 82 : 74
  })), import_react25.default.createElement(Box, {
    ...
    textAlign: "center"
  }, import_react25.default.createElement(Text, {
    as: "h1",
    color: "modalText",
    id: titleId,
    size: mobile ? "20" : "18",
    weight: "heavy"
  }, accountName)), balanceData && import_react25.default.createElement(Box, {
    textAlign: "center"
  }, import_react25.default.createElement(Text, {
    as: "h1",
    color: "modalTextSecondary",
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, balance, " ", balanceData.symbol)))), import_react25.default.createElement(Box, {
    display: "flex",
    flexDirection: "row",
    gap: "8",
    margin: "2",
    marginTop: "16"
  }, import_react25.default.createElement(ProfileDetailsAction, {
    action: copyAddressAction,
    icon: copiedAddress ? import_react25.default.createElement(CopiedIcon, null) : import_react25.default.createElement(CopyIcon, null),
    label: copiedAddress ? "Copied!" : "Copy Address"
  }), import_react25.default.createElement(ProfileDetailsAction, {
    action: onDisconnect,
    icon: import_react25.default.createElement(DisconnectIcon, null),
    label: "Disconnect"
  }))), showRecentTransactions && import_react25.default.createElement(import_react25.default.Fragment, null, import_react25.default.createElement(Box, {
    background: "generalBorder",
    height: "1",
    marginTop: "-1"
  }), import_react25.default.createElement(Box, null, import_react25.default.createElement(TxList, {
    address
  })))));
}
function AccountModal({
  ...
  return import_react17.default.createElement(import_react17.default.Fragment, null, address && import_react17.default.createElement(Dialog, {
    onClose,
    open,
    titleId
  }, import_react17.default.createElement(DialogContent, {
    bottomSheetOnMobile: true,
    padding: "0"
  }, import_react17.default.createElement(ProfileDetails, {
    address,
    balanceData,
    ensAvatar,
    ensName,
...
var DisconnectSqIcon = ({ size }) => import_react40.default.createElement("svg", {
  fill: "none",
  height: size,
  viewBox: "0 0 28 28",
  width: size,
...
var MenuButton = import_react41.default.forwardRef(({ children, currentlySelected = false, onClick, ...urlProps }, ref) => {
  const mobile = isMobile();
...
function ChainModal({
  ...
  const [switchingToChain, setSwitchingToChain] = (0, import_react39.useState)();
  ...
  const stopSwitching = (0, import_react39.useCallback)(() => {
  ...
  const { appName } = (0, import_react39.useContext)(AppContext);
  if (!activeChain || !(activeChain == null ? void 0 : activeChain.id)) {
    return null;
  }
  return import_react39.default.createElement(Dialog, {
    onClose,
    open,
    titleId
    ...
    flexDirection: "row",
    justifyContent: "space-between"
  }, mobile && import_react39.default.createElement(Box, {
    width: "30"
  }), import_react39.default.createElement(Box, {
    paddingBottom: "0",
    paddingLeft: "8",
    paddingTop: "4"
  }, import_react39.default.createElement(Text, {
    as: "h1",
    color: "modalText",
    id: titleId,
    size: mobile ? "20" : "18",
    weight: "heavy"
  }, "Switch Networks")), import_react39.default.createElement(CloseButton, {
    onClose
  })), unsupportedChain && import_react39.default.createElement(Box, {
    marginX: "8",
    ...
    size: "14",
    weight: "medium"
  }, "Wrong network detected, switch or disconnect to continue.")), import_react39.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4",
    padding: "2"
    ...
    return import_react39.default.createElement(import_react39.Fragment, {
      key: chain.id
    }, import_react39.default.createElement(MenuButton, {
    ...
    }, chainIconUrl ? import_react39.default.createElement(Box, {
      height: "full",
      marginRight: "8"
    }, import_react39.default.createElement(AsyncImage, {
      alt: chain.name,
    ...
    })) : null, import_react39.default.createElement("div", null, chain.name)), isCurrentChain && import_react39.default.createElement(Box, {
      alignItems: "center",
      display: "flex",
      flexDirection: "row",
      marginRight: "6"
      ...
      size: "14",
      weight: "medium"
    }, "Connected"), import_react39.default.createElement(Box, {
      ...
      marginLeft: "8",
      width: "8"
    })), switching && import_react39.default.createElement(Box, {
      alignItems: "center",
      display: "flex",
      flexDirection: "row",
      marginRight: "6"
      ...
      size: "14",
      weight: "medium"
    }, "Confirm in Wallet"), import_react39.default.createElement(Box, {
      background: "standby",
      borderRadius: "full",
      height: "8",
      marginLeft: "8",
      width: "8"
    }))))), mobile && idx < (chains == null ? void 0 : chains.length) - 1 && import_react39.default.createElement(Box, {
      background: "generalBorderDim",
      height: "1",
      marginX: "8"
    }));
    ...
    size: "14",
    weight: "medium"
  }, "Your wallet does not support switching networks from", " ", appName != null ? appName : "this app", ". Try switching networks from within your wallet instead.")), unsupportedChain && import_react39.default.createElement(import_react39.default.Fragment, null, import_react39.default.createElement(Box, {
    background: "generalBorderDim",
    height: "1",
    marginX: "8"
  }), import_react39.default.createElement(MenuButton, {
    ...
    justifyContent: "center",
    marginRight: "8"
  }, import_react39.default.createElement(DisconnectSqIcon, {
    size: Number(chainIconSize)
  })), import_react39.default.createElement("div", null, "Disconnect"))))))))));
}
function isSafari() {
...
var DisclaimerText = ({ children }) => {
  return import_react48.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "12",
    weight: "medium"
  }, children);
};
var src = async () => (await import("./assets-7THATBKH-ABODE5GX.js")).default;
var preloadAssetsIcon = () => loadImages(src);
var AssetsIcon = () => import_react49.default.createElement(AsyncImage, {
  background: "#d0d5de",
  borderRadius: "10",
  height: "48",
  src,
...
var src2 = async () => (await import("./login-EJZTP74Q-RJBFX7VE.js")).default;
var preloadLoginIcon = () => loadImages(src2);
var LoginIcon = () => import_react50.default.createElement(AsyncImage, {
  background: "#d0d5de",
  borderRadius: "10",
  height: "48",
  src: src2,
...
function ConnectModalIntro({ getWallet }) {
  const { disclaimer: Disclaimer, learnMoreUrl } = (0, import_react45.useContext)(AppContext);
  return import_react45.default.createElement(import_react45.default.Fragment, null, import_react45.default.createElement(Box, {
    ...
    size: "18",
    weight: "heavy"
  }, "What is a Wallet?")), import_react45.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "32",
    justifyContent: "center",
    ...
    minWidth: "48",
    width: "48"
  }, import_react45.default.createElement(AssetsIcon, null)), import_react45.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, import_react45.default.createElement(Text, {
    ...
    size: "14",
    weight: "bold"
  }, "A Home for your Digital Assets"), import_react45.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, "Wallets are used to send, receive, store, and display digital assets like Ethereum and NFTs."))), import_react45.default.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    gap: "16"
    ...
    minWidth: "48",
    width: "48"
  }, import_react45.default.createElement(LoginIcon, null)), import_react45.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, import_react45.default.createElement(Text, {
    ...
    size: "14",
    weight: "bold"
  }, "A New Way to Log In"), import_react45.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, "Instead of creating new accounts and passwords on every website, just connect your wallet.")))), import_react45.default.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    gap: "12",
    justifyContent: "center",
    margin: "10"
  }, import_react45.default.createElement(ActionButton, {
    label: "Get a Wallet",
    onClick: getWallet
  }), import_react45.default.createElement(Box, {
    as: "a",
    ...
    size: "14",
    weight: "bold"
  }, "Learn More"))), Disclaimer && import_react45.default.createElement(Box, {
    marginBottom: "8",
    marginTop: "12",
    textAlign: "center"
  }, import_react45.default.createElement(Disclaimer, {
    Link: DisclaimerLink,
    Text: DisclaimerText
  }))));
}
...
var useCoolMode = (imageUrl) => {
  ...
  const coolModeEnabled = (0, import_react53.useContext)(CoolModeContext);
...
var ModalSelection = ({
  ...
  return import_react52.default.createElement(Box, {
    ...
    src: iconUrl,
    width: "28"
  }), import_react52.default.createElement("div", null, name)))));
};
ModalSelection.displayName = "ModalSelection";
var useWindowSize = () => {
  const [windowSize, setWindowSize] = (0, import_react55.useState)({
...
var src3 = async () => (await import("./create-GVGWOEGN-PTB65BQZ.js")).default;
var preloadCreateIcon = () => loadImages(src3);
var CreateIcon = () => import_react56.default.createElement(AsyncImage, {
  background: "#e3a5e8",
  height: "48",
  src: src3,
  width: "48"
});
var src4 = async () => (await import("./scan-RESLZYEA-A6YKSAB7.js")).default;
var preloadScanIcon = () => loadImages(src4);
var ScanIcon = () => import_react57.default.createElement(AsyncImage, {
  background: "#515a70",
  height: "48",
  src: src4,
  width: "48"
...
function QRCode({
  ...
  const dots = (0, import_react58.useMemo)(() => {
    const dots2 = [];
    ...
    qrList.forEach(({ x, y }) => {
      ...
      for (let i = 0; i < 3; i++) {
        dots2.push(import_react58.default.createElement("rect", {
        ...
        if (matrix[i][j]) {
          if (!(i < 7 && j < 7 || i > matrix.length - 8 && j < 7 || i < 7 && j > matrix.length - 8)) {
            if (!(i > matrixMiddleStart && i < matrixMiddleEnd && j > matrixMiddleStart && j < matrixMiddleEnd)) {
              dots2.push(import_react58.default.createElement("circle", {
  ...
  return import_react58.default.createElement(Box, {
    ...
    width: "full"
  }, import_react58.default.createElement(AsyncImage, {
    ...
    src: logoUrl,
    width: logoSize
  })), import_react58.default.createElement("svg", {
    height: size,
    style: { all: "revert" },
    width: size
  }, import_react58.default.createElement("defs", null, import_react58.default.createElement("clipPath", {
    id: "clip-wrapper"
  }, import_react58.default.createElement("rect", {
    height: logoWrapperSize,
    width: logoWrapperSize
  })), import_react58.default.createElement("clipPath", {
    id: "clip-logo"
  }, import_react58.default.createElement("rect", {
    height: logoSize,
    width: logoSize
...
function GetDetail({
  ...
  return import_react54.default.createElement(Box, {
    ...
    return import_react54.default.createElement(Box, {
      ...
      size: "14",
      weight: "bold"
    }, name), import_react54.default.createElement(Text, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
    }, hasMobileCompanionApp ? "Mobile Wallet" : (downloadUrls == null ? void 0 : downloadUrls.browserExtension) ? "Browser Extension" : null))), import_react54.default.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    ...
    size: "14",
    weight: "bold"
  }, "Not what you\u2019re looking for?"), import_react54.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
...
function ConnectDetail({
  ...
  return import_react54.default.createElement(Box, {
    ...
    height: "full",
    width: "full"
  }, qrCode && qrCodeUri ? import_react54.default.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "full",
    justifyContent: "center"
  }, import_react54.default.createElement(QRCode, {
    ...
    size: "20",
    weight: "bold"
  }, ready ? `Opening ${name}` : (downloadUrls == null ? void 0 : downloadUrls.browserExtension) ? `${name} is not installed` : `${name} is not available`), import_react54.default.createElement(Box, {
    color: "modalTextSecondary",
    display: "flex",
    flexDirection: "row",
    gap: "6",
    height: "24"
  }, connectionError ? import_react54.default.createElement(Text, {
    color: "error",
    size: "16",
    textAlign: "center",
    weight: "bold"
  }, "Error connecting, please retry!") : import_react54.default.createElement(import_react54.default.Fragment, null, ready ? import_react54.default.createElement(SpinnerIcon, null) : null, import_react54.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "16",
    textAlign: "center",
    weight: "bold"
  }, readyMsg))), !ready && (downloadUrls == null ? void 0 : downloadUrls.browserExtension) ? import_react54.default.createElement(Box, {
    paddingTop: "20"
  }, import_react54.default.createElement(ActionButton, {
    href: downloadUrls.browserExtension,
    label: "INSTALL",
    type: "secondary"
  })) : null))), import_react54.default.createElement(Box, {
    alignItems: "center",
    borderRadius: "10",
    display: "flex",
    flexDirection: "row",
    ...
    justifyContent: "space-between",
    marginTop: "12"
  }, !ready ? null : import_react54.default.createElement(import_react54.default.Fragment, null, import_react54.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, secondaryAction.description), import_react54.default.createElement(ActionButton, {
...
function DownloadDetail({
  ...
  return import_react54.default.createElement(Box, {
    ...
    size: "14",
    weight: "semibold"
  }, "Scan with your phone to download on iOS or Android")), import_react54.default.createElement(Box, {
    height: "full"
  }, (downloadUrls == null ? void 0 : downloadUrls.qrCode) ? import_react54.default.createElement(QRCode, {
    logoSize: 0,
    size: 268,
...
var stepIcons = {
  create: () => import_react54.default.createElement(CreateIcon, null),
  install: (wallet2) => import_react54.default.createElement(AsyncImage, {
  ...
  scan: () => import_react54.default.createElement(ScanIcon, null)
};
function InstructionDetail({
  ...
  return import_react54.default.createElement(Box, {
    ...
    return import_react54.default.createElement(Box, {
      ...
      position: "relative",
      width: "48"
    }, (_a2 = stepIcons[d.step]) == null ? void 0 : _a2.call(stepIcons, wallet2)), import_react54.default.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, import_react54.default.createElement(Text, {
      ...
      size: "14",
      weight: "bold"
    }, d.title), import_react54.default.createElement(Text, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
    }, d.description)));
...
function DesktopOptions({ onClose }) {
  ...
  const safari = isSafari();
  const [selectedOptionId, setSelectedOptionId] = (0, import_react44.useState)();
  const [selectedWallet, setSelectedWallet] = (0, import_react44.useState)();
  const [qrCodeUri, setQrCodeUri] = (0, import_react44.useState)();
  const hasQrCode = !!(selectedWallet == null ? void 0 : selectedWallet.qrCode);
  const [connectionError, setConnectionError] = (0, import_react44.useState)(false);
  ...
  const [initialWalletStep, setInitialWalletStep] = (0, import_react44.useState)("NONE");
  const [walletStep, setWalletStep] = (0, import_react44.useState)("NONE");
  ...
  switch (walletStep) {
    case "NONE":
      walletContent = import_react44.default.createElement(ConnectModalIntro, {
        getWallet: () => changeWalletStep("GET")
      });
      break;
    case "GET":
      walletContent = import_react44.default.createElement(GetDetail, {
        getMobileWallet
      });
      ...
      break;
    case "CONNECT":
      walletContent = selectedWallet && import_react44.default.createElement(ConnectDetail, {
        changeWalletStep,
        connectionError,
        qrCodeUri,
      ...
      break;
    case "DOWNLOAD":
      walletContent = selectedWallet && import_react44.default.createElement(DownloadDetail, {
        changeWalletStep,
        wallet: selectedWallet
      });
      ...
      break;
    case "INSTRUCTIONS":
      walletContent = selectedWallet && import_react44.default.createElement(InstructionDetail, {
  ...
  return import_react44.default.createElement(Box, {
    ...
    paddingBottom: "8",
    paddingX: "18"
  }, import_react44.default.createElement(Text, {
    as: "h1",
    color: "modalText",
    id: titleId,
    size: "18",
    weight: "heavy"
  }, "Connect a Wallet")), import_react44.default.createElement(Box, {
    className: ScrollClassName,
    paddingBottom: "18"
  }, Object.entries(groupedWallets).map(([groupName, wallets2], index) => wallets2.length > 0 && import_react44.default.createElement(import_react44.Fragment, {
    key: index
  }, groupName ? import_react44.default.createElement(Box, {
    marginBottom: "8",
    marginTop: "16",
    marginX: "6"
  }, import_react44.default.createElement(Text, {
    ...
    size: "14",
    weight: "bold"
  }, groupName)) : null, import_react44.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, wallets2.map((wallet2) => {
    return import_react44.default.createElement(ModalSelection, {
  ...
  })))))), !isMobile() && import_react44.default.createElement(import_react44.default.Fragment, null, import_react44.default.createElement(Box, {
    background: "generalBorder",
    minWidth: "1",
    width: "1"
  }), import_react44.default.createElement(Box, {
    ...
    width: "28"
  }, headerBackButtonLink && import_react44.default.createElement(Box, {
    as: "button",
    className: touchableStyles({
      active: "shrinkSm",
      hover: "growLg"
    ...
    transition: "default",
    type: "button"
  }, import_react44.default.createElement(BackIcon, null))), import_react44.default.createElement(Box, {
    display: "flex",
    justifyContent: "center",
    style: { flexGrow: 1 }
  }, headerLabel && import_react44.default.createElement(Text, {
    color: "modalText",
    size: "18",
    textAlign: "center",
    weight: "heavy"
  }, headerLabel)), import_react44.default.createElement(CloseButton, {
    onClose
  })), import_react44.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
...
function WalletButton({ wallet: wallet2 }) {
  ...
  return import_react59.default.createElement(Box, {
    ...
    fontFamily: "body",
    key: id,
    onClick: (0, import_react59.useCallback)(async () => {
    ...
    type: "button",
    width: "full"
  }, import_react59.default.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    justifyContent: "center"
    ...
    paddingBottom: "8",
    paddingTop: "10"
  }, import_react59.default.createElement(AsyncImage, {
    background: iconBackground,
    borderRadius: "13",
    ...
    flexDirection: "column",
    textAlign: "center"
  }, import_react59.default.createElement(Text, {
    as: "h2",
    ...
    as: "span",
    position: "relative"
  }, shortName != null ? shortName : name, !wallet2.ready && " (unsupported)")), wallet2.recent && import_react59.default.createElement(Text, {
    color: "accentColor",
    size: "12",
    weight: "medium"
  }, "Recent"))));
...
function MobileOptions({ onClose }) {
  ...
  let headerBackButtonLink = null;
  const [walletStep, setWalletStep] = (0, import_react59.useState)("CONNECT");
  const ios = isIOS();
  switch (walletStep) {
    case "CONNECT": {
      headerLabel = "Connect a Wallet";
      headerBackgroundContrast = true;
      walletContent = import_react59.default.createElement(Box, null, import_react59.default.createElement(Box, {
        background: "profileForeground",
        className: scroll,
        display: "flex",
        paddingBottom: "20",
        ...
        return import_react59.default.createElement(Box, {
          ...
          width: "60"
        }, import_react59.default.createElement(WalletButton, {
          wallet: wallet2
        })));
      }))), import_react59.default.createElement(Box, {
        background: "generalBorder",
        ...
        size: "16",
        weight: "bold"
      }, "What is a Wallet?"), import_react59.default.createElement(Text, {
        color: "modalTextSecondary",
        size: "16"
      }, "A wallet is used to send, receive, store, and display digital assets. It\u2019s also a new way to log in, without needing to create new accounts and passwords on\xA0every\xA0website."))), import_react59.default.createElement(Box, {
        paddingTop: "32",
        paddingX: "20"
      }, import_react59.default.createElement(Box, {
        display: "flex",
        gap: "14",
        justifyContent: "center"
      }, import_react59.default.createElement(ActionButton, {
        label: "Get a Wallet",
        ...
        size: "large",
        type: "secondary"
      }))), Disclaimer && import_react59.default.createElement(Box, {
        marginTop: "28",
        marginX: "32",
        textAlign: "center"
      }, import_react59.default.createElement(Disclaimer, {
        Link: DisclaimerLink,
        Text: DisclaimerText
      })));
      break;
    ...
    case "GET": {
      ...
      walletContent = import_react59.default.createElement(Box, null, import_react59.default.createElement(Box, {
        ...
        return import_react59.default.createElement(Box, {
          ...
          size: "18",
          weight: "bold"
        }, name)), import_react59.default.createElement(ActionButton, {
          href: ios ? downloadUrls == null ? void 0 : downloadUrls.ios : downloadUrls == null ? void 0 : downloadUrls.android,
          label: "GET",
          size: "small",
          type: "secondary"
        })), index < mobileWallets.length - 1 && import_react59.default.createElement(Box, {
          background: "generalBorderDim",
          height: "1",
          marginY: "10",
          width: "full"
        ...
        size: "16",
        weight: "bold"
      }, "Not what you\u2019re looking for?"), import_react59.default.createElement(Text, {
        color: "modalTextSecondary",
        size: "16"
  ...
  return import_react59.default.createElement(Box, {
    ...
    paddingX: "20",
    position: "relative"
  }, headerBackButtonLink && import_react59.default.createElement(Box, {
    display: "flex",
    position: "absolute",
    style: {
      left: 0,
    ...
    transition: "default",
    type: "button"
  }, import_react59.default.createElement(BackIcon, null))), import_react59.default.createElement(Box, {
    marginTop: "4",
    textAlign: "center",
    width: "full"
  }, import_react59.default.createElement(Text, {
    ...
    size: "20",
    weight: "bold"
  }, headerLabel)), import_react59.default.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "32",
    paddingRight: "14",
  ...
  }, import_react59.default.createElement(CloseButton, {
    onClose
  }))))), import_react59.default.createElement(Box, {
    display: "flex",
    flexDirection: "column"
...
function ConnectOptions({ onClose }) {
  return isMobile() ? import_react43.default.createElement(MobileOptions, {
    onClose
  }) : import_react43.default.createElement(DesktopOptions, {
    onClose
  });
}
function ConnectModal({ onClose, open }) {
  ...
  return !isConnected ? import_react42.default.createElement(Dialog, {
    onClose,
    open,
    titleId
  }, import_react42.default.createElement(DialogContent, {
    bottomSheetOnMobile: true,
    padding: "0",
    wide: true
  }, import_react42.default.createElement(ConnectOptions, {
    onClose
  }))) : null;
}
var units = ["k", "m", "b", "t"];
...
var useBooleanState = (initialValue) => {
  ...
  const setTrue = (0, import_react13.useCallback)(() => setValue(true), []);
  const setFalse = (0, import_react13.useCallback)(() => setValue(false), []);
...
function ConnectButtonRenderer({
  ...
  const showRecentTransactions = (0, import_react13.useContext)(ShowRecentTransactionsContext);
  ...
  const preloadImages = (0, import_react13.useCallback)(() => {
  ...
  return import_react13.default.createElement(import_react13.default.Fragment, null, children({
    ...
    openChainModal,
    openConnectModal
  }), import_react13.default.createElement(ConnectModal, {
    onClose: closeConnectModal,
    open: connectModalOpen
  }), import_react13.default.createElement(AccountModal, {
    address,
    balanceData,
    ensAvatar,
    ensName,
  ...
  }), import_react13.default.createElement(ChainModal, {
    activeChain,
    chains,
    networkError,
...
function ConnectButton({
  ...
  return import_react4.default.createElement(ConnectButtonRenderer, null, ({
    ...
    }, mounted && account ? import_react4.default.createElement(import_react4.default.Fragment, null, chain && (chains.length > 1 || unsupportedChain) && import_react4.default.createElement(Box, {
      alignItems: "center",
      as: "button",
...
var WalletConnectConnector = class extends Connector {
  ...
  async getProvider() {
    ...
    if (!_classPrivateFieldGet(this, _provider) || chainId || create) {
      ...
      const WalletConnectProvider = (await import("./esm-HH6SAHNW.js")).default;
...
var CoinbaseWalletConnector = class extends Connector {
  ...
  async getProvider() {
    if (!_classPrivateFieldGet(this, _provider2)) {
      ...
      let CoinbaseWalletSDK = (await import("./dist-536EWBRJ.js")).default;
...
var argent = ({ chains }) => ({
  id: "argent",
  name: "Argent",
  iconUrl: async () => (await import("./argent-5L2T73SY-PI2UG4VJ.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var brave = ({ chains, shimDisconnect }) => {
  ...
  return {
    id: "brave",
    name: "Brave Wallet",
    iconUrl: async () => (await import("./brave-GT2DMA7C-G2WEXG4X.js")).default,
    iconBackground: "#fff",
...
var coinbase = ({ appName, chains }) => {
  return {
    ...
    shortName: "Coinbase",
    iconUrl: async () => (await import("./coinbase-G3UAZG2M-GXBKNNBT.js")).default,
...
var imToken = ({ chains }) => ({
  id: "imToken",
  name: "imToken",
  iconUrl: async () => (await import("./imToken-LFPF6XA3-O54JNL77.js")).default,
...
var injected = ({
  ...
  iconUrl: async () => (await import("./injected-NV2ZDWID-WJCX2A2A.js")).default,
  iconBackground: "#fff",
  createConnector: () => ({
    connector: new InjectedConnector({
      chains,
...
var ledger = ({ chains }) => ({
  ...
  iconBackground: "#000",
  name: "Ledger Live",
  iconUrl: async () => (await import("./ledger-FR4A2GHX-AJAQ4O7Q.js")).default,
  downloadUrls: {
...
var metaMask = ({
  ...
  return {
    id: "metaMask",
    name: "MetaMask",
    iconUrl: async () => (await import("./metaMask-CP52H6U7-WPU4ZBJE.js")).default,
    iconBackground: "#fff",
...
var rainbow = ({ chains }) => ({
  id: "rainbow",
  name: "Rainbow",
  iconUrl: async () => (await import("./rainbow-MRMCEQFY-XDPHPAY5.js")).default,
...
var steak = ({ chains }) => ({
  id: "steak",
  name: "Steakwallet",
  iconUrl: async () => (await import("./steak-WN465AL2-BKOP77DQ.js")).default,
  iconBackground: "#000",
  downloadUrls: {
...
var trust = ({ chains, shimDisconnect }) => ({
  id: "trust",
  name: "Trust Wallet",
  iconUrl: async () => (await import("./trust-V37V6CEN-QAKER2UT.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var walletConnect = ({ chains }) => ({
  id: "walletConnect",
  name: "WalletConnect",
  iconUrl: async () => (await import("./walletConnect-WGMZ526J-DP6JQIPP.js")).default,
...
function useAddRecentTransaction() {
  ...
  const { address } = useAccount();
  const chainId = useChainId();
  return (0, import_react60.useCallback)((transaction) => {
    if (!address || !chainId) {
      throw new Error("No address or chain ID found");
    }
