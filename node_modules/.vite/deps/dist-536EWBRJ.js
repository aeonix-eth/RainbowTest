...
var require_wallet_logo = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/assets/wallet-logo.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.walletLogo = void 0;
    ...
    exports2.walletLogo = walletLogo;
  }
});
...
var require_DiagnosticLogger = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/connection/DiagnosticLogger.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_types = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/types.js"(exports2) {
    ...
    })(ProviderType = exports2.ProviderType || (exports2.ProviderType = {}));
  }
});
    ...
    Readable.prototype.wrap = function(stream) {
      ...
      for (var i3 in stream) {
        if (this[i3] === void 0 && typeof stream[i3] === "function") {
          this[i3] = function methodWrap(method2) {
  ...
  "node_modules/keccak/lib/api/index.js"(exports2, module2) {
    ...
    module2.exports = function(KeccakState) {
      ...
      return function(algorithm2, options) {
        const hash = typeof algorithm2 === "string" ? algorithm2.toLowerCase() : algorithm2;
        switch (hash) {
          case "keccak224":
...
var require_pify = __commonJS({
  "node_modules/eth-block-tracker/node_modules/pify/index.js"(exports2, module2) {
    "use strict";
...
function w(n2, l3, u3, i3, t3, o3, r3, f3, s3, a3) {
  ...
  for (u3.__k = [], h3 = 0; h3 < l3.length; h3++)
    if (null != (_3 = u3.__k[h3] = null == (_3 = l3[h3]) || "boolean" == typeof _3 ? null : "string" == typeof _3 || "number" == typeof _3 || "bigint" == typeof _3 ? y(null, _3, null, null, _3) : Array.isArray(_3) ? y(d, { children: _3 }, null, null, null) : _3.__b > 0 ? y(_3.type, _3.props, _3.key, null, _3.__v) : _3)) {
      ...
      j(n2, _3, p3 = p3 || e, t3, o3, r3, f3, s3, a3), b3 = _3.__e, (v3 = _3.ref) && p3.ref != v3 && (g3 || (g3 = []), p3.ref && g3.push(p3.ref, null, _3), g3.push(v3, _3.__c || b3, _3)), null != b3 ? (null == m3 && (m3 = b3), "function" == typeof _3.type && _3.__k === p3.__k ? _3.__d = s3 = x(_3, s3, n2) : s3 = P(n2, _3, p3, w3, b3, s3), "function" == typeof u3.type && (u3.__d = s3)) : s3 && p3.__e == s3 && s3.parentNode != n2 && (s3 = k(p3));
    }
  for (u3.__e = m3, h3 = A3; h3--; )
    null != w3[h3] && ("function" == typeof u3.type && null != w3[h3].__e && w3[h3].__e == u3.__d && (u3.__d = k(i3, h3 + 1)), N(w3[h3], w3[h3]));
  if (g3)
...
function j(n2, u3, i3, t3, o3, r3, f3, e3, c3) {
  var s3, h3, v3, y3, p3, k3, b3, m3, g3, x3, A3, P2, C2, $2 = u3.type;
  ...
  try {
    n:
      if ("function" == typeof $2) {
        if (m3 = u3.props, g3 = (s3 = $2.contextType) && t3[s3.__c], x3 = s3 ? g3 ? g3.props.value : s3.__ : t3, i3.__c ? b3 = (h3 = u3.__c = i3.__c).__ = h3.__E : ("prototype" in $2 && $2.prototype.render ? u3.__c = h3 = new $2(m3, x3) : (u3.__c = h3 = new _(m3, x3), h3.constructor = $2, h3.render = O), g3 && g3.sub(h3), h3.props = m3, h3.state || (h3.state = {}), h3.context = x3, h3.__n = t3, v3 = h3.__d = true, h3.__h = []), null == h3.__s && (h3.__s = h3.state), null != $2.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = a({}, h3.__s)), a(h3.__s, $2.getDerivedStateFromProps(m3, h3.__s))), y3 = h3.props, p3 = h3.state, v3)
          null == $2.getDerivedStateFromProps && null != h3.componentWillMount && h3.componentWillMount(), null != h3.componentDidMount && h3.__h.push(h3.componentDidMount);
        else {
          if (null == $2.getDerivedStateFromProps && m3 !== y3 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(m3, x3), !h3.__e && null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(m3, h3.__s, x3) || u3.__v === i3.__v) {
        ...
        if (h3.context = x3, h3.props = m3, h3.__v = u3, h3.__P = n2, A3 = l.__r, P2 = 0, "prototype" in $2 && $2.prototype.render)
          h3.state = h3.__s, h3.__d = false, A3 && A3(u3), s3 = h3.render(h3.props, h3.state, h3.context);
        else
          do {
            h3.__d = false, A3 && A3(u3), s3 = h3.render(h3.props, h3.state, h3.context), h3.state = h3.__s;
          } while (h3.__d && ++P2 < 25);
        h3.state = h3.__s, null != h3.getChildContext && (t3 = a(a({}, t3), h3.getChildContext())), v3 || null == h3.getSnapshotBeforeUpdate || (k3 = h3.getSnapshotBeforeUpdate(y3, p3)), C2 = null != s3 && s3.type === d && null == s3.key ? s3.props.children : s3, w(n2, Array.isArray(C2) ? C2 : [C2], u3, i3, t3, o3, r3, f3, e3, c3), h3.base = u3.__e, u3.__h = null, h3.__h.length && f3.push(h3), b3 && (h3.__E = h3.__ = null), h3.__e = false;
      } else
...
function q2(n2) {
  var r3 = u2.context[n2.__c], o3 = p2(t2++, 9);
      ...
      return (0, preact_1.h)(
        ...
        (0, preact_1.h)(
          ...
          (0, preact_1.h)(
            ...
            !props.connectDisabled ? (0, preact_1.h)(ScanQRBox, { darkMode, version: props.version, sessionId: props.sessionId, sessionSecret: props.sessionSecret, linkAPIUrl: props.linkAPIUrl, isConnected: props.isConnected, isParentConnection: props.isParentConnection }) : null,
...
var require_Web3Response = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/relay/Web3Response.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.EthereumAddressFromSignedMessageResponse = exports2.SubmitEthereumTransactionResponse = exports2.SignEthereumTransactionResponse = exports2.SignEthereumMessageResponse = exports2.isRequestEthereumAccountsResponse = exports2.SelectProviderResponse = exports2.WatchAssetReponse = exports2.RequestEthereumAccountsResponse = exports2.SwitchEthereumChainResponse = exports2.AddEthereumChainResponse = exports2.ErrorResponse = void 0;
    ...
    exports2.SelectProviderResponse = SelectProviderResponse;
...
var require_CoinbaseWalletSDK = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/CoinbaseWalletSDK.js"(exports2) {
    ...
    exports2.CoinbaseWalletSDK = CoinbaseWalletSDK;
 ...
 * @license MIT
 */
//# sourceMappingURL=dist-536EWBRJ.js.map
